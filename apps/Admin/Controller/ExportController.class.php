...
class ExportController extends BaseController {
	...
	public function orderlists(){
        ...
        $obj  = new \Common\Helper\ExcelHelper();
	    	$title = array('订单号','支付单号','买家账号','收货人','下单时间','订单状态', '订单金额','商品金额','运费','支付方式','交易流水号','支付时间','退款金额','买家联系方式','收货人联系方式','收货地址','发货时间','快递公司','物流单号');
			$export = array();
			...
			foreach($list as $k =>$v) {
				...
				$export[$k]['reciver_info_area_info'] = $orderCommon['reciver_info']['area_info'];
