...
class SettingModel extends Model{
	...
	if($return['statistics_code']) 
	$return['statistics_code'] = stripslashes($return['statistics_code']);
            return $return;
        }else {
    ...
    public function getSettings($condition = array()){
	   ...
	   if($res['statistics_code'])
        $res['statistics_code'] = stripslashes($res['statistics_code']);
