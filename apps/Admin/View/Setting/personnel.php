                                ...
                                <div id="item_list" class="item-list">
                                    <foreach name="item_list" item="vo">
                                        <div nctype="special_item" <if condition="$vo.item_usable eq 1 "> class="special-item goods usable" <else /> class="special-item goods unusable"  </if> data-item-id="{$vo.item_id}">
                                            ...
                                            "></i>下移</a> <a nctype="btn_usable" data-item-id="{$vo.item_id}" href="javascript:;"><i class="fa fa-toggle-on
                                            "></i>启用</a> <a nctype="btn_edit_item" data-item-id="{$vo.item_id}" href="javascript:;"><i class="fa fa-pencil-square-o"></i>编辑</a> <a nctype="btn_del_item" data-item-id="{$vo.item_id}" href="javascript:;"><i class="fa fa-trash-o
                                            "></i>删除</a>
                                            </div>
