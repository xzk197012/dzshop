...
class Alipays {
	...
	public function __construct($param){
		...
		$this->notify_url = ($param['notify_url']?$param['notify_url']:$this->paypath."/api.php/Payment/alipayNotify");
		$this->return_url = ($param['return_url']?$param['return_url']:$this->paypath."/api.php/Payment/alipayReturn");
  	...
  	private function aliConfig(){
		...
		$alipay_config['return_url'] = $this->return_url;
		//签名方式
