    ...
    <div class="white-bg paddingB30">
        <div class="tab-conbox <?php if($search_arr['search_key'] != 'amount'){ echo 'none'; } ?>">
            <ul class="stati-tab radius5">
                <li class="<?php echo ($search_arr['search_type']=='day'?'stati-active-bg':''); ?>"><a href="<?php echo U('Statistics/customer',array('search_type'=>'day','search_key'=>'amount'));?>">今天</a></li>
                <li class="<?php echo ($search_arr['search_type']=='week'?'stati-active-bg':''); ?>"><a href="<?php echo U('Statistics/customer',array('search_type'=>'week','search_key'=>'amount'));?>">最近7天</a></li>
                <li class="<?php echo ($search_arr['search_type']=='month'?'stati-active-bg':''); ?>"><a href="<?php echo U('Statistics/customer',array('search_type'=>'month','search_key'=>'amount'));?>">最近30天</a></li>
            </ul>
        ...
        <div class="tab-conbox <?php if($search_arr['search_key'] != 'num'){ echo 'none'; } ?>">
            <ul class="stati-tab radius5">
                <li class="<?php echo ($search_arr['search_type']=='day'?'stati-active-bg':''); ?>"><a href="<?php echo U('Statistics/customer',array('search_type'=>'day','search_key'=>'num'));?>">今天</a></li>
                <li class="<?php echo ($search_arr['search_type']=='week'?'stati-active-bg':''); ?>"><a href="<?php echo U('Statistics/customer',array('search_type'=>'week','search_key'=>'num'));?>">最近7天</a></li>
                <li class="<?php echo ($search_arr['search_type']=='month'?'stati-active-bg':''); ?>"><a href="<?php echo U('Statistics/customer',array('search_type'=>'month','search_key'=>'num'));?>">最近30天</a></li>
            </ul>
