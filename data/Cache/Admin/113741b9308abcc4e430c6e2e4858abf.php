    ...
    <div class="white-bg">
        ...
        <div class="comtable-box boxsizing">
            <table class="com-table">
                ...
                <tbody>
                <?php if(empty($message)): ?><tr class="tr-minH">
                        <td colspan="3">暂无数据！</td>
                        <td></td>
                    </tr>
                <?php else: ?>
                <?php if(is_array($message)): foreach($message as $key=>$mess): ?><tr>
                        <td>
                        ...
                        <td ><div class="td-word classify-name text-l"><?php echo ($mess["name"]); ?></div></td>
                         <td ><div class="td-word classify-name text-l"><?php echo ($mess["wx_content"]); ?></div></td>
                          <td id="temp" >
                            <?php if($mess["wx_states"] == '1'): ?><div class="state-btn yes-state">
                                    <i class="yes-icon"></i>
                                    <span>开启</span>
                                </div>
                                <?php else: ?>
