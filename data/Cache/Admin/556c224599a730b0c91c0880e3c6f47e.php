...
<div class="iframeCon">
    ...
    <div class="white-bg text-c">
                    ...
                    <div class="coupon-box-det sc-coupon-det">
                        <div class="coupon-box-top">
                            <div class="coupon-top-con">
                                <div class="zoom">
                                    <p class="coupon-subtit left change-title" change-default=""><?php echo ($info["rpacket_t_title"]); ?></p>
                                    <p class="count-limit right">每人限领<span class="change-eachlimit" change-default="xx"><?php echo ($info["rpacket_t_eachlimit"]); ?></span>张</p>
                                </div>
                                <div class="zoom couponMoney-box">
                                    <div class="left">
                                        <span class="money-unit">¥</span>
                                        <span class="money-num change-price"  change-default="xxx" ><?php echo ($info["rpacket_t_price"]); ?></span>
                                    </div>
                                    <div class="right">
                                        <p class="coupon-share ">
                                            <span class="change-points coupon-red" change-default="xxx积分兑换"><?php echo ($info["rpacket_t_points"]); ?></span>积分兑换
                                        <p>
                        ...
                        <div class="coupon-box-bottom">
                            <p class="coupon-bottom-tit">订单满<span class="change-limit coupon-bottom-tit" change-default="xxx"><?php echo ($info["rpacket_t_limit"]); ?></span>元（含运费）</p>
                        ...
                        <div class="coupon-box-top coupon-box-top_wx">
                            <div class="coupon-top-con">
                                ...
                                <div class="zoom couponMoney-box">
                                    ...
                                    <div class="right">
                                    <img src="/static/admin/images/wx_statu.png" alt="" class="coupon-statu"/>
            ...
            <div class="coupon-right" >
                <div class="couponR-con">
                    <div class="coupon-edit-box">
                        <form method="post" class="form-horizontal" name="redpacke_form" id="redpacke_form" action="<?php echo U('Coupon/edit');?>">
                            ...
                            <table class="coupon-table">
                                <tr>
                                    ...
                                    <td><input type="text" class="coupon-inp changenow" change-key="title" localrequired="empty;limit:50" name="rpacket_t_title"  value="<?php echo ($info["rpacket_t_title"]); ?>" id="rpacket_t_title" />
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="release-price coupon-table-num">
                                            <input type="text" class="price-inp left" localrequired="empty;intval" name="rpacket_t_total"  value="<?php echo ($info["rpacket_t_total"]); ?>" id="rpacket_t_total" />
                                            <input type="hidden" class="price-inp left"  name="id"  value="<?php echo ($info["rpacket_t_id"]); ?>"  />
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="release-price coupon-table-num">
                                            <input type="text" class="price-inp left changenow" change-key="price" localrequired="empty;intval" name="rpacket_t_price"  value="<?php echo ($info["rpacket_t_price"]); ?>" id="rpacket_t_price" />
                                    ...
                                    <td>
                                        <div class="coupon-full">
                                            <div class="release-price coupon-table-num left full-num">
                                                <input type="text" class="price-inp left changenow" change-key="limit" localrequired="intval;empty;gt:rpacket_t_price" name="rpacket_t_limit"  value="<?php echo ($info["rpacket_t_limit"]); ?>" id="rpacket_t_limit" <?php if($info['rpacket_t_wx'] == 1){ ?>readonly="true" <?php }?>/>
                                                <span class="price-unit left">元</span>
                                            </div>
                            ...
                            <table class="coupon-table">
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" class="coupon-inp changenow" localrequired="intval;empty;lt:50" change-key="eachlimit" name="rpacket_t_eachlimit"  value="<?php echo ($info["rpacket_t_eachlimit"]); ?>" id="rpacket_t_eachlimit" /><span class="tips-tag" tips="最多50张"><i class="tips-icon"></i></span>
                                ...
                                <tr <?php if($info['rpacket_t_wx'] == 1){ ?>style="display: none"<?php }?>>
                                    ...
                                    <td>
                                        <input type="text" class="coupon-inp changenow" change-key="points" localrequired="intval;empty" name="rpacket_t_points"  value="<?php echo ($info["rpacket_t_points"]); ?>" id="rpacket_t_points"/><span class="tips-tag" tips="兑换优惠券所需积分，0为免费领取"><i class="tips-icon"></i></span>
                                    </td>
                                </tr>
                                <tr <?php if($info['rpacket_t_wx'] == 1){ ?>style="display: none"<?php }?>>
                                    <td>状态</td>
        ...
        <div class="btn-box-center borderT-none">
            <a class="btn1 radius3" id="form_submitadd" href="javascript:;"><?php echo (L("submit_btn")); ?></a>
            <a class="btn1 radius3 marginL5" href='<?php echo U("coupon/lists");?>'>返回列表</a>
        </div>
    </div>
</div>
