    ...
    <div class="white-bg">
        <div class="table-titbox">
            ...
            <ul class="operation-list left">
                <li class="add-li"><a href="<?php echo U('Wx/imgTextAdd');?>"><span><i href="#" class="operation-icon add-icon"></i></span></a></li>
        ...
        <div class="comtable-box boxsizing">
            <table class="com-table">
                ...
                <?php else: ?>
                <?php if(is_array($getdatalist)): foreach($getdatalist as $key=>$imgtext): ?><tr id="menu_<?php echo ($imgtext["tid"]); ?>" class="menulid_<?php echo ($imgtext["tid"]); ?>">
                        <td>
                            <div class="table-iconbox">
                                <div class="edit-iconbox left edit-sele marginR10">
                                    <a class="edit-word table-icon-a delmenu"  href="javascript:void(0)" id="<?php echo ($imgtext["tid"]); ?>"><i class="table-com-icon table-dele-icon"></i><span class="gap">删除</span></a>
                                </div>
                                <div class="edit-iconbox left edit-sele marginR10">
                        ...
                        <td ><div class="td-word classify-name text-l"><?php echo ($imgtext["modename"]); ?></div></td>
                        <td><?php echo ($imgtext["imgnum"]); ?></td>
                        <td>
                            <?php echo (date('Y-m-d H:i:s',$imgtext["dataline"])); ?>
                        </td>
                        <td></td>
