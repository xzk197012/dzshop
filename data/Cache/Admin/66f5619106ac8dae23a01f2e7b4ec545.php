            ...
            <div class="coupon-right">
                 <div class="couponR-con">
                    <div class="coupon-edit-box">
                        <form method="post" class="form-horizontal" name="redpacke_form" id="redpacke_form" action="<?php echo U('Coupon/add');?>">
                                ...
                                <td>
                                    <div class="coupon-full">
                                        <div class="release-price coupon-table-num left full-num">
                                            <input type="text" class="price-inp left changenow" change-key="limit" localrequired="intval;empty;gt:rpacket_t_price" name="rpacket_t_limit"  value="<?php echo ($info["rpacket_t_limit"]); ?>" id="rpacket_t_limit"/>
                                            <span class="price-unit left">元</span>
                                        </div>
