...
<link href="/static/admin/css/base-print.css" rel="stylesheet" type="text/css"/>
<link href="/static/admin/css/print.css" rel="stylesheet" type="text/css"/>
<script type="text/javascript" src="/static/admin/js/jquery-1.7.1.min.js" charset="utf-8"></script>

<script type="text/javascript" src="/static/admin/js/jquery.poshytip.min.js" charset="utf-8"></script>
<script type="text/javascript" src="/static/admin/js/jquery.printarea.js" charset="utf-8"></script>
  ...
  <div class="print-page">
    <div id="printarea">
        ...
        <table class="order-info">
          ...
          <tbody>
		  <?php $num = 0; foreach($ordersGoods as $k=>$v) {?>
             <tr>
              <td><?php echo $k+1; ?></td>
