<?php if (!defined('THINK_PATH')) exit();?><tr id="spu_tr_<?php echo $_GET['goods_common_id'];?>" class="sku-tr">
	<td colspan="7" class="text-l" >
		...
		<ul class="sku-list">
			...
			<li>
				<div class="sku_img_div"><img src="http://www.tqshq.com/data/Attach/<?php echo $sku['goods_image']?>" url="http://www.tqshq.com/data/Attach/<?php echo $sku['goods_image']?>"     alt="" class="sku-pic  pre_view_img"/></div>
