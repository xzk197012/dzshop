...
<div class="iframeMain">
       <ul class="transverse-nav">
        <li class="<?php echo ($type==''?'activeFour':''); ?>"><a href="<?php echo U('Group/activelist');?>"><span>活动列表</span></a></li>
		<li class="<?php echo ($type=='10'?'activeFour':''); ?>"><a href="<?php echo U('Group/grouplist');?>?type=10"><span>开团列表</span></a></li>
		<li class="<?php echo ($type=='20'?'activeFour':''); ?>"><a href="<?php echo U('Group/joinlists');?>?type=20"><span>参团列表</span></a></li>
    </ul>
    <div class="white-bg">
        <div class="table-titbox">
            <h1 class="table-tit left boxsizing">活动列表</h1>
            <ul class="operation-list left">
                <li class="add-li"  title="新增活动" ><a  href="<?php echo U('Group/group');?>"><span><i  class="operation-icon add-icon"></i></a></span></li>
