    ...
    <div class="scrollbox" style="overflow-y: scroll; overflow-x: hidden;">
		...
		<div class="tipsbox">
			...
			<ol class="tips-list" id="tips-list">
				<?php echo (L("permiss_group_edit_tips")); ?>
			</ol>
		</div>
<div class="iframeCon">
<div class="iframeMain">
			<ul class="transverse-nav">
				<li class="activeFour"><a href="javascript:;"><span><?php echo (L("permiss_group_edit")); ?></span></a></li>
			</ul>
	...
	<div class="white-shadow2">
		<div class="jurisdiction boxsizing">
			...
			<dl class="juris-dl boxsizing dlborder-bot">
				<dt class="left text-r boxsizing"><span class="redstar">*</span><?php echo (L("permiss_setting")); ?>：</dt>
				<dd class="left text-l">
...
<script type="text/javascript">
    $(function(){
        $('#form_submitadd').click(function(){
            ...
            if(nameval == 0){
            	showError(<?php echo (L("permiss_select_only_one")); ?>);
            	return;
            }else{
	            if(!flag){
	                $('#role_form').submit();
