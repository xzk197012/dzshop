		...
		<div class="iframeMain">
			<div class="white-bg">
				<div class="table-titbox">
					<div class="option">
						<h1 class="table-tit left boxsizing"><?php echo (L("manager_list")); ?></h1>
					...
					<table class="com-table">
						<thead>
							<tr>
								...
								<th class='text-l' width="180"><?php echo (L("manager")); ?></th>
								<th class='text-l' width="180"><?php echo (L("permiss_group")); ?></th>
								<th width="180"><?php echo (L("manager_last_login_time")); ?></th>
								<th width="120">IP</th>
								<th></th>
							</tr>
						</thead>
						<tbody>
							<?php if(empty($lists)): ?><tr class="tr-minH">
			                        <td colspan="5"><?php echo (L("no_data")); ?></td>
			                        <td></td>
			                    </tr>
			                <?php else: ?>
									...
									<td>
										<div class="table-iconbox">
											<div class="edit-iconbox left edit-sele marginR10">
												<a class="edit-word table-icon-a" href="<?=U('/system/add/id/'.$v['uid'])?>"><i class="table-com-icon table-edit-icon"></i><span class="gap"><?php echo (L("edit")); ?></span></a>
											</div>
											<div class="edit-iconbox left edit-sele marginR10">
												<a class="edit-word table-icon-a btn-del" href="javascript:;" rel-href="<?=U('/system/del/uid/'.$v['uid'])?>"><i class="table-com-icon table-dele-icon"></i><span class="gap"><?php echo (L("delete")); ?></span></a>
											</div>
										</div>
									</td>
		...
		<script type="text/javascript">
			$(function(){
				...
				$('.add-li').mousemove(function(){
					...
					remindNeed($('.add-li'),e,'<?php echo (L("manager_add")); ?>');
				})
