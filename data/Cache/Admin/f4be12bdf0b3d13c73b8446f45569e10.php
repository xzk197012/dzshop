...
<?php  if(!$_GET['goods_state']){ $_GET['goods_state'] = 'online'; } ?>
...
<div class="alert dialog_element none  showAlert radius3 addSpec-alert specialAlert">
	...
	<div class="alert-btnbox boxsizing">
		<a   id="remove_class_btn"  href="javascript:;"  class="btn1 radius3"><?php echo (L("submit_btn")); ?></a>
	</div>
	</form>
</div>
<!--弹窗结束-->
				...
				<tr class="detail-tr">
					<td class="text-l">
						<div class="commodity-box">
							...
							<div><img src="http://www.tqshq.com/data/Attach/<?php echo $v['goods_image'];?>"  url="http://www.tqshq.com/data/Attach/<?php echo $v['goods_image'];?>"   alt="" class="commodity-pic pre_view_img"/></div>
					...
					<td>
						<?php echo $v['goods_cost_price'];?>
					</td>
					<td>
						<?php echo $v['goods_price'];?>
					</td>
					<td class="">
						<?php echo $category_names[$v['gc_id_1']]; if($v['gc_id_2']){ ?> > <?php echo $category_names[$v['gc_id_2']]; } ?>
					</td>
					<td>
					...
					<td class="posiR">
						<img src="http://www.tqshq.com/data/Attach/goods_qcode/<?php echo ($v['goods_common_id']%100).'/'.$v['goods_common_id'].'.png'; ?>"  url="http://www.tqshq.com/data/Attach/goods_qcode/<?php echo ($v['goods_common_id']%100).'/'.$v['goods_common_id'].'.png'; ?>"  class="pre_view_img  breviary-code " />
					</td>
					<?php }else{ ?>
					<td class="posiR">
						--
