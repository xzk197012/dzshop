		...
		getdata(searchurl,data,function(data) {
			...
			if(good.length > 0){
				for(i in good){
					...
					li +='<li  ><a href="#"><img src="'+good[i].goods_image+'" alt="" class="icon-img"/><p class="icon-name" goods_common_id="'+good[i].goods_common_id+'"  goods_id="'+good[i].goods_id+'" sign_price="'+good[i].goods_price+'" goods_storage="'+good[i].goods_storage+'" goods_images="'+goods_images_first+'">'+good[i].goods_name+'</p></a></li>';
				}
			}else{
